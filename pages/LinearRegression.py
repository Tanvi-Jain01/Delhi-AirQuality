...
line = ax.plot(range(len(train_time_df['true_y'])), X_train_i['PM2.5'], train_time_df['true_y'], label='True Y')
line2 = ax.plot(range(len(train_time_df['true_y'])), X_train_i['PM2.5'], train_time_df['pred_y'], label='Pred Y')
ax.legend()
ax.set_xlabel('Date')
ax.set_ylabel('Pm2.5')
